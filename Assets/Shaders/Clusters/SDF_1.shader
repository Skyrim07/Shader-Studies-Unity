...
Shader "AlexLiu/SDF_1"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                float sdist = sdf_sphere(pos, mul(unity_ObjectToWorld, _Center), _Size);
                float bdist = sdf_box(pos, mul(unity_ObjectToWorld, _Center), _Size);
                return lerp(sdist, bdist, _Blend);
            }
