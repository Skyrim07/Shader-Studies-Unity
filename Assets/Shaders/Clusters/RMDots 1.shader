Shader "AlexLiu/RMDots1"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed RayMarch(float3 startPos, float3 dir)
            {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                rmColor = lerp(_DotColor * 2, _HighlightColor, saturate(rm));
                rmColor.rgb *= (N11(rm) / _RMRandom + (1 - 1 / _RMRandom));
